#  <p align="center"> <a href=https://github.com/Darius-D/Insectic/tree/main/prototype> Click here</a> to see current Prototype and <a href=https://github.com/Darius-D/Insectic/tree/master> Code </a></p>
 ## Table of Contents 
 1. [Why Insectic?](#head)
...
|10|While consuming APIs in postman worked, I ran into issues with sending post request in my project. The properties that required DateTime inputs are requiring Datetime inputs even though in the model the datatype is DateTime.Date. Currently looking for solutions to this issue. | No current solution| April 6,2021|Problem is now resolved. Issue was caused by having the default value of "dateTime.Now" in the model to be assigned upon construction of a new object of type Ticket. This was interfering with the assignment of the incident date and due date properties in SQL server|April 7, 2021|
***
